...
@property (nonatomic, strong) UIColor * _Nonnull notificationLabelBackgroundColor;
@property (nonatomic, strong) UIColor * _Nonnull notificationLabelTextColor;
@property (nonatomic, strong) UIFont * _Nonnull notificationLabelFont;
...
- (void)displayNotificationWithMessage:(NSString * _Nonnull)message forDuration:(NSTimeInterval)duration;
